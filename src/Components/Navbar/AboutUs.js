                        ...
                        <Accordion.Body className="AuAccBody">
                            ...
                            <div>
                                <ul>
                                    ...
                                    <li>GC (GC, automatic liquid sampler).</li>
                                    <li>Balance (ant-vibration frequency table of 10 Hz).</li>
                                    <li>Dissolution testing (USP).</li>
                                    <li>Analytical office (monitoring, documentation).</li>
                                    <li>Wet lab (titration, standards, glassware).</li>
                                    <li>Stability (monitoring system, power backup).</li>
                                    <li>DC licenced storage (reagents, samples).</li>
                                    <li>Fume hood, cleaning (glassware, volatile reagents).</li>
                                </ul>
                            </div>
                        </Accordion.Body>
                    </Accordion.Item>
